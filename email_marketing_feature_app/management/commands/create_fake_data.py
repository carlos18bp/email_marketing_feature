...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        call_command('create_users', number_of_users=number_of_records)
        call_command('create_emails', number_of_emails=number_of_records)
        call_command('create_users_emails', number_of_users_emails=number_of_records)
